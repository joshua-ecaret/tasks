<div class="btn-group" role="group" aria-label="Actions">
    ...
    {{-- Delete Button --}}
    <form action="{{ route('packages.destroy', $id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this package?')">
        @csrf
        @method('DELETE')
        <button type="submit" class="btn  btn-sm" title="Delete Package">
            <svg xmlns="http://www.w3.org/2000/svg"
                 width="16" height="16"
