...
class PackageTest extends TestCase
{
    ...
    public static function invalidPackageData(): array
    {
        return [
            ...
            'max_rollover_credits ' => [['max_rollover_credits' => 0], 'apply_credit_rollover'],
    ...
    public function test_index_returns_empty_array_when_no_packages()
    {
        $response = $this->getJson('packages');
    ...
    public function test_destroy_package_success()
    {
        ...
        $response = $this->deleteJson("packages/{$package->id}");
